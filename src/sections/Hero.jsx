...
const Hero = () => {
  const [bigShoeImg, setBigShoeImg] = useState(shoes[0])
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <p className="font-montserrat text-slate-gray leading-8 mt-6 mb-14 gap-16">Discover stylish Nike arrivals, quality comfort and innovation for your active life</p>
